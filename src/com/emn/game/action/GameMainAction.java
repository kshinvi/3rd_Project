...
public class GameMainAction extends EmnAction implements ModelDriven<PointBean>, Preparable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public static final Logger log = Logger.getLogger(GameMainAction.class);
